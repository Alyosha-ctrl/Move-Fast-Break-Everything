...
public class TestMovement : MonoBehaviour
{
    ...
    {
        return facing * (dashSpeed+dashMovementSO.agilityScaling) * Time.fixedDeltaTime;
    }
    ...
    private Vector2 Slide()
    {
        ...
        return facing*(slideMovementSO.movePower+slideMovementSO.agilityScaling+slideMovementSO.dexterityScaling)*Time.fixedDeltaTime;
    }
    ...
    private Vector2 ChargeDecay()
    {
        ...
        // Debug.Log("In Slide Decay");
        // rb.MovePosition(rb.position + facing*(slideMovementSO.movePower)*Time.fixedDeltaTime);
        return facing*(chargeMovementSO.movePower+chargeMovementSO.strengthScaling)*Time.fixedDeltaTime;
    }
    //__________________________________________________________________________________________________
}
